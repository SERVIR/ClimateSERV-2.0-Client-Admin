...
// 
export class APILogsSummary extends React.Component
{
    constructor(props) 
    {
        super(props);
    ...
    componentDidMount()
    {
        //console.log("APILogsSummary.componentDidMount: Reached the end!");
    }
